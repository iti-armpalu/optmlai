    ...
    cards: [
        {
            ...
            bullets: [
                { label: "Natural language queries", icon: Check, iconClass: "text-green-500" },
                { label: "AI-powered recommendations", icon: Check, iconClass: "text-green-500" },
                { label: "Contextual insights", icon: Check, iconClass: "text-green-500" },
                { label: "Smart pattern recognition", icon: Check, iconClass: "text-green-500" },
            ],
            cta: { label: "Try Chat Demo", href: "/demo/chat", variant: "outline" },
        },
        {
            id: "advanced-heatmapping",
            ...
            bullets: [
                { label: "Click heatmaps", icon: Check, iconClass: "text-green-500" },
                { label: "Scroll depth tracking", icon: Check, iconClass: "text-green-500" },
                { label: "Attention mapping", icon: Check, iconClass: "text-green-500" },
                { label: "Mobile & desktop views", icon: Check, iconClass: "text-green-500" },
            ],
